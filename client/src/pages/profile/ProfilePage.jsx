...
const ProfilePage = () => {
  ...
  const isMyProfile =
    authUser?.user?._id &&
    user?._id &&
    authUser.user._id.toString() === user._id.toString();
  ...
  const { mutate: updateProfile, isPending: isUpdatingProfile } = useMutation({
    mutationFn: async () => {
      try {
        ...
        throw new Error(error.message); // ✅ Ensure only the message is thrown
      }
    },
    onSuccess: () => {
    ...
    onError: (error) => {
      // ✅ Ensure `toast.error` receives a string
